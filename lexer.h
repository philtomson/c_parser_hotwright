...
typedef enum {
    // Keywords
    TOKEN_INT, TOKEN_BOOL, TOKEN_BITINT, TOKEN_CHAR, TOKEN_UNSIGNED, TOKEN_VOID, TOKEN_TRUE, TOKEN_FALSE, TOKEN_IF, TOKEN_ELSE, TOKEN_WHILE, TOKEN_FOR, TOKEN_RETURN, TOKEN_BREAK, TOKEN_CONTINUE,
